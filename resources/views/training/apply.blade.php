        ...
        <div class="row" v-show="step === 1">
            <div class="col-xl-6 col-lg-12 col-md-12 mb-12">
                <div class="card shadow mb-4 border-left-warning">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><i class="fas fa-exclamation-triangle"></i>&nbsp;NOTICE TO NEW CONTROLLERS</h5>
                        <p class="card-text">To be eligible to control in our subdivision, please visit <a href="https://portugal-vacc.org/join" target="_blank">https://portugal-vacc.org/join</a> and follow the provided steps. You will be granted access to all required training materials through our Moodle platform, where your introductory session will also be scheduled. After obtaining your S1 rating, you may then request the following ratings through this website.</p>
                        <hr>
